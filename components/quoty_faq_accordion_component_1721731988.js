...
Vue.component("quoty_faq_accordion_component_1721731988", {
    template: `
    <section class="py-8 bg-white pl-4">
        <h2 class="text-lg font-semibold mb-5">Frequently Asked Questions About Our Ethereum Blockchain Explorer</h2>
        <!-- Accordion -->
        <div class="space-y-3">
            <!-- Accordion item -->
    ...
    data() {
        return {
            terms: [
                { title: "What is an Ethereum blockchain explorer?", description: "An Ethereum blockchain explorer is a tool that allows you to search, view and analyze data from the Ethereum blockchain network. It provides transparent information about transactions, addresses, smart contracts and more.", expanded: false },
                { title: "How can I use your Ethereum explorer?", description: "Our easy-to-use interface lets you quickly search for specific transactions, addresses, blocks and other on-chain data. Advanced filtering and visualization options are also available.", expanded: false },
                { title: "What makes your Ethereum explorer unique?", description: "Our explorer goes beyond just showing data - it helps you discover new Ethereum blockchains and projects. Our proprietary algorithms surface promising opportunities before they become mainstream.", expanded: false },
                { title: "Is your Ethereum explorer free to use?", description: "Yes, our core Ethereum blockchain explorer is completely free to use. We offer premium paid plans with more advanced features and data for power users.", expanded: false },
            ],
        };
    },
    methods: {
